    ...
    const order = await FoodOrder.findOneAndUpdate(
        ...
        },
        {
            $set: {
                ...
                // Deassign & Resend is an explicit opt-in to the broadcast hunt, so a
                // previously hand-assigned order stops being off-limits to auto-dispatch.
                'dispatch.assignedBy': 'AUTO',
