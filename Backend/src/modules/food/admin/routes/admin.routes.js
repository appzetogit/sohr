...
// Orders taken over WhatsApp: admin types them in, then hand-picks the rider.
router.post(
    '/orders/manual',
    requireAdminPermission('order_management', 'edit'),
    orderController.createManualOrderAdminController
);
router.patch(
    '/orders/:orderId/assign',
    requireAdminPermission('order_management', 'edit'),
    orderController.assignDeliveryPartnerController
);
