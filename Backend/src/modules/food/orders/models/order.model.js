...
const dispatchSchema = new mongoose.Schema(
    {
        ...
        /**
         * 'ADMIN' when an admin hand-picked the rider for this order.
         *
         * Auto-dispatch must leave those alone: tryAutoAssign reclaims any 'assigned'
         * order older than the accept window, which would otherwise broadcast a
         * manually assigned order to every nearby rider ~50s later. Stays 'ADMIN'
         * after a reject/timeout too — the order goes back to the admin, not to the
         * broadcast hunt. Resend / Deassign & Resend set it back to 'AUTO'.
         */
        assignedBy: { type: String, enum: ['ADMIN', 'AUTO'], default: 'AUTO' },
